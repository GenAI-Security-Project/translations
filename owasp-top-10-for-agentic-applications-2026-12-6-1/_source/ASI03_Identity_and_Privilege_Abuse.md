...
Delegated Privilege Abuse: A finance agent delegates to a “DB query” agent but passes all its
...
Memory-Based Escalation: An IT admin agent caches SSH credentials during a patch. Later a non-
...
Cross-Agent Trust Exploitation: A crafted email from IT instructs an email sorting agent to instruct
