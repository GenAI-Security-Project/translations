...
5. Use of exposed, unsanitized functions powering agent memory that have access to
...
6. Memory System RCE: An attacker exploits an unsafe function in the agent's memory
...
Architecture and design: Isolate per-session environments with permission boundaries; apply least
