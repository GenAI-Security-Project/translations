...
## Top-10-Leiter und Themenverantwortliche

Die OWASP Top 10 für Agentische Anwendungen wurde von John Sotiropoulos (Deep Cyber), Keren Katz

(Tenable) und Ron F Del Rosario (SAP) geleitet, mit der entscheidenden Unterstützung der

Themenverantwortlichen, ohne die dies nicht möglich gewesen wäre.
...
Alejandro Saucedo - Vorsitzender des ML Security Project der Linux Foundation, UN-KI-Experte, KI-Experte für

Technologiepolitik, Europäische Kommission
...
Steve Wilson - Co-Vorsitzender des OWASP GenAI Security Project, Gründer der Top 10 for LLM

Applications, Chief Product Officer, Exabeam

Scott Clinton - Co-Vorsitzender des Boards des OWASP GenAI Security Project und Mitbegründer

Vasilios Mavroudis - Principal Research Scientist und Theme Lead, das Alan Turing Institute

Josh Collyer, Principal Security Researcher, Theme Lead

Egor Pushkin, Chief Architect, Data and AI bei Oracle Cloud
...
Weitere Organisationen, die an unserer öffentlichen Überprüfung teilgenommen haben:
